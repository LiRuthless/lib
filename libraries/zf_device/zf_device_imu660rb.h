...
//====================================================软件 SPI 驱动====================================================
	#define IMU660RB_SPC_PIN            (P33)                           // 软件 SPI SCK  引脚
	#define IMU660RB_SDI_PIN            (P32)                           // 软件 SPI MOSI 引脚
	#define IMU660RB_SDO_PIN            (P43)                           // 软件 SPI MISO 引脚
	#define IMU660RB_CS_PIN             (P37)                        	// 软件 SPI CS   引脚
//====================================================软件 SPI 驱动====================================================
